...
#list.sort - позволяет отсортировать по порядку элементы

age = [9.05, 7, 0, -34, 109]
age.sort ()
print (age) # или можно записать проще ( print (age.sort ()) )

# можно, с помощбю функции - sum - посчитать сумму всех элементов

age = [9.56, 7, 0, -34, 109, - 71]
print (sum (age))
