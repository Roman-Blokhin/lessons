...
# здесь я хочу прописать функции, которые сейчас самостоятельно воспроизвожу для большей осознанности

def zoo (animal):
    print ('Сейчас', animal, 'на обеде')

zoo_list = ['Слон', 'Обезьяна', 'Белка', 'Муравей', 'Лев', 'Птерадактиль', 'Крокодил', ]

for element in zoo_list:
    zoo (animal = element) # можно написать просто (element), так как у нас одно значение у функции zoo

print ('---------------------------')

# просто для себя пример
def sum (a, b):
...
def game ():
    """Ничего не делаем с этой функцией

    И это правда. Совсем ничего!"""
    pass
